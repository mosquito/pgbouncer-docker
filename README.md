...
- [Configuration](#configuration)
    ...
    * [Entrypoint specific settings](#entrypoint-specific-settings)
        + [ENV: `FORKS`](#env---forks-)
        + [ENV: `LOG_LEVEL`](#env---log-level-)
    * [User authentication settings](#user-authentication-settings)
        + [ENV: `AUTH_{username}={password}`](#env---auth--username---password--)
- [Generic settings](#generic-settings)
    + [ENV: `PGBOUNCER_LISTEN_ADDR`](#env---pgbouncer-listen-addr-)
    + [ENV: `PGBOUNCER_LISTEN_PORT`](#env---pgbouncer-listen-port-)
    + [ENV: `PGBOUNCER_AUTH_HBA_FILE`](#env---pgbouncer-auth-hba-file-)
    + [ENV: `PGBOUNCER_AUTH_TYPE`](#env---pgbouncer-auth-type-)
    + [ENV: `PGBOUNCER_AUTH_QUERY`](#env---pgbouncer-auth-query-)
    + [ENV: `PGBOUNCER_AUTH_USER`](#env---pgbouncer-auth-user-)
    + [ENV: `PGBOUNCER_POOL_MODE`](#env---pgbouncer-pool-mode-)
    + [ENV: `PGBOUNCER_MAX_CLIENT_CONN`](#env---pgbouncer-max-client-conn-)
    + [ENV: `PGBOUNCER_DEFAULT_POOL_SIZE`](#env---pgbouncer-default-pool-size-)
    + [ENV: `PGBOUNCER_MIN_POOL_SIZE`](#env---pgbouncer-min-pool-size-)
    + [ENV: `PGBOUNCER_RESERVE_POOL_SIZE`](#env---pgbouncer-reserve-pool-size-)
    + [ENV: `PGBOUNCER_RESERVE_POOL_TIMEOUT`](#env---pgbouncer-reserve-pool-timeout-)
    + [ENV: `PGBOUNCER_MAX_DB_CONNECTIONS`](#env---pgbouncer-max-db-connections-)
    + [ENV: `PGBOUNCER_MAX_USER_CONNECTIONS`](#env---pgbouncer-max-user-connections-)
    + [ENV: `PGBOUNCER_SERVER_ROUND_ROBIN`](#env---pgbouncer-server-round-robin-)
    + [ENV: `PGBOUNCER_IGNORE_STARTUP_PARAMETERS`](#env---pgbouncer-ignore-startup-parameters-)
    + [ENV: `PGBOUNCER_DISABLE_PQEXEC`](#env---pgbouncer-disable-pqexec-)
    + [ENV: `PGBOUNCER_APPLICATION_NAME_ADD_HOST`](#env---pgbouncer-application-name-add-host-)
    + [ENV: `PGBOUNCER_CONFFILE`](#env---pgbouncer-conffile-)
    + [ENV: `PGBOUNCER_SERVICE_NAME`](#env---pgbouncer-service-name-)
    + [ENV: `PGBOUNCER_JOB_NAME`](#env---pgbouncer-job-name-)
    + [ENV: `PGBOUNCER_STATS_PERIOD`](#env---pgbouncer-stats-period-)
    * [Log settings](#log-settings)
        + [ENV: `PGBOUNCER_LOG_CONNECTIONS`](#env---pgbouncer-log-connections-)
        + [ENV: `PGBOUNCER_LOG_DISCONNECTIONS`](#env---pgbouncer-log-disconnections-)
        + [ENV: `PGBOUNCER_LOG_POOLER_ERRORS`](#env---pgbouncer-log-pooler-errors-)
        + [ENV: `PGBOUNCER_LOG_STATS`](#env---pgbouncer-log-stats-)
        + [ENV: `PGBOUNCER_VERBOSE`](#env---pgbouncer-verbose-)
    * [Console access control](#console-access-control)
        + [ENV: `PGBOUNCER_ADMIN_USERS`](#env---pgbouncer-admin-users-)
        + [ENV: `PGBOUNCER_STATS_USERS`](#env---pgbouncer-stats-users-)
    * [Connection sanity checks, timeouts](#connection-sanity-checks--timeouts)
        + [ENV: `PGBOUNCER_SERVER_RESET_QUERY`](#env---pgbouncer-server-reset-query-)
        + [ENV: `PGBOUNCER_SERVER_RESET_QUERY_ALWAYS`](#env---pgbouncer-server-reset-query-always-)
        + [ENV: `PGBOUNCER_SERVER_CHECK_DELAY`](#env---pgbouncer-server-check-delay-)
        + [ENV: `PGBOUNCER_SERVER_CHECK_QUERY`](#env---pgbouncer-server-check-query-)
        + [ENV: `PGBOUNCER_SERVER_FAST_CLOSE`](#env---pgbouncer-server-fast-close-)
        + [ENV: `PGBOUNCER_SERVER_LIFETIME`](#env---pgbouncer-server-lifetime-)
        + [ENV: `PGBOUNCER_SERVER_IDLE_TIMEOUT`](#env---pgbouncer-server-idle-timeout-)
        + [ENV: `PGBOUNCER_SERVER_CONNECT_TIMEOUT`](#env---pgbouncer-server-connect-timeout-)
        + [ENV: `PGBOUNCER_SERVER_LOGIN_RETRY`](#env---pgbouncer-server-login-retry-)
        + [ENV: `PGBOUNCER_CLIENT_LOGIN_TIMEOUT`](#env---pgbouncer-client-login-timeout-)
        + [ENV: `PGBOUNCER_AUTODB_IDLE_TIMEOUT`](#env---pgbouncer-autodb-idle-timeout-)
        + [ENV: `PGBOUNCER_DNS_MAX_TTL`](#env---pgbouncer-dns-max-ttl-)
        + [ENV: `PGBOUNCER_DNS_NXDOMAIN_TTL`](#env---pgbouncer-dns-nxdomain-ttl-)
        + [ENV: `PGBOUNCER_DNS_ZONE_CHECK_PERIOD`](#env---pgbouncer-dns-zone-check-period-)
        + [ENV: `PGBOUNCER_RESOLV_CONF`](#env---pgbouncer-resolv-conf-)
    * [TLS settings](#tls-settings)
        + [ENV: `PGBOUNCER_CLIENT_TLS_SSLMODE`](#env---pgbouncer-client-tls-sslmode-)
        + [ENV: `PGBOUNCER_CLIENT_TLS_KEY_FILE`](#env---pgbouncer-client-tls-key-file-)
        + [ENV: `PGBOUNCER_CLIENT_TLS_CERT_FILE`](#env---pgbouncer-client-tls-cert-file-)
        + [ENV: `PGBOUNCER_CLIENT_TLS_CA_FILE`](#env---pgbouncer-client-tls-ca-file-)
        + [ENV: `PGBOUNCER_CLIENT_TLS_PROTOCOLS`](#env---pgbouncer-client-tls-protocols-)
        + [ENV: `PGBOUNCER_CLIENT_TLS_CIPHERS`](#env---pgbouncer-client-tls-ciphers-)
        + [ENV: `PGBOUNCER_CLIENT_TLS_ECDHCURVE`](#env---pgbouncer-client-tls-ecdhcurve-)
        + [ENV: `PGBOUNCER_CLIENT_TLS_DHEPARAMS`](#env---pgbouncer-client-tls-dheparams-)
        + [ENV: `PGBOUNCER_SERVER_TLS_SSLMODE`](#env---pgbouncer-server-tls-sslmode-)
        + [ENV: `PGBOUNCER_SERVER_TLS_CA_FILE`](#env---pgbouncer-server-tls-ca-file-)
        + [ENV: `PGBOUNCER_SERVER_TLS_KEY_FILE`](#env---pgbouncer-server-tls-key-file-)
        + [ENV: `PGBOUNCER_SERVER_TLS_CERT_FILE`](#env---pgbouncer-server-tls-cert-file-)
        + [ENV: `PGBOUNCER_SERVER_TLS_PROTOCOLS`](#env---pgbouncer-server-tls-protocols-)
        + [ENV: `PGBOUNCER_SERVER_TLS_CIPHERS`](#env---pgbouncer-server-tls-ciphers-)
    * [Dangerous timeouts](#dangerous-timeouts)
        + [ENV: `PGBOUNCER_QUERY_TIMEOUT`](#env---pgbouncer-query-timeout-)
        + [ENV: `PGBOUNCER_QUERY_WAIT_TIMEOUT`](#env---pgbouncer-query-wait-timeout-)
        + [ENV: `PGBOUNCER_CLIENT_IDLE_TIMEOUT`](#env---pgbouncer-client-idle-timeout-)
        + [ENV: `PGBOUNCER_IDLE_TRANSACTION_TIMEOUT`](#env---pgbouncer-idle-transaction-timeout-)
        + [ENV: `PGBOUNCER_SUSPEND_TIMEOUT`](#env---pgbouncer-suspend-timeout-)
    * [Low-level network settings](#low-level-network-settings)
        + [ENV: `PGBOUNCER_PKT_BUF`](#env---pgbouncer-pkt-buf-)
        + [ENV: `PGBOUNCER_MAX_PACKET_SIZE`](#env---pgbouncer-max-packet-size-)
        + [ENV: `PGBOUNCER_LISTEN_BACKLOG`](#env---pgbouncer-listen-backlog-)
        + [ENV: `PGBOUNCER_SBUF_LOOPCNT`](#env---pgbouncer-sbuf-loopcnt-)
        + [ENV: `PGBOUNCER_TCP_DEFER_ACCEPT`](#env---pgbouncer-tcp-defer-accept-)
        + [ENV: `PGBOUNCER_TCP_SOCKET_BUFFER`](#env---pgbouncer-tcp-socket-buffer-)
        + [ENV: `PGBOUNCER_TCP_KEEPALIVE`](#env---pgbouncer-tcp-keepalive-)
        + [ENV: `PGBOUNCER_TCP_KEEPCNT`](#env---pgbouncer-tcp-keepcnt-)
        + [ENV: `PGBOUNCER_TCP_KEEPIDLE`](#env---pgbouncer-tcp-keepidle-)
        + [ENV: `PGBOUNCER_TCP_KEEPINTVL`](#env---pgbouncer-tcp-keepintvl-)
        + [ENV: `PGBOUNCER_TCP_USER_TIMEOUT`](#env---pgbouncer-tcp-user-timeout-)
    * [Section [databases]](#section--databases-)
        + [ENV: `DATABASES_DBNAME`](#env---databases-dbname-)
        + [ENV: `DATABASES_HOST`](#env---databases-host-)
        + [ENV: `DATABASES_PORT`](#env---databases-port-)
        + [ENV: `DATABASES_USER`](#env---databases-user-)
        + [ENV: `DATABASES_PASSWORD`](#env---databases-password-)
        + [ENV: `DATABASES_AUTH_USER`](#env---databases-auth-user-)
        + [ENV: `DATABASES_POOL_SIZE`](#env---databases-pool-size-)
        + [ENV: `DATABASES_RESERVE_POOL`](#env---databases-reserve-pool-)
        + [ENV: `DATABASES_CONNECT_QUERY`](#env---databases-connect-query-)
        + [ENV: `DATABASES_POOL_MODE`](#env---databases-pool-mode-)
        + [ENV: `DATABASES_MAX_DB_CONNECTIONS`](#env---databases-max-db-connections-)
        + [ENV: `DATABASES_CLIENT_ENCODING`](#env---databases-client-encoding-)
        + [ENV: `DATABASES_DATESTYLE`](#env---databases-datestyle-)
        + [ENV: `DATABASES_TIMEZONE`](#env---databases-timezone-)
...
The configuration is set in the environment variables. All environment variables are built according to the same principle,
`{SECTION}_{PARAMETER_NAME}={VALUE}`, where `{SECTION}` is the name of the section from the configuration file pgbouncer.ini,
`{PARAMETER_NAME}` is the value of the parameter, and `{VALUE}` is a parameter value.
